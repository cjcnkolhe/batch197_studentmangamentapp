    ...
    <table class="table-dark table table-striped ">
     ...
     <tr>
        <tr> 
           ...
           <a class="btn btn-success me-1" href="fees?rollno=${s.studentId}">Pay-Fees</a><a class="btn btn-primary me-1">BatchShift</a><a href="delete?rollno=${s.studentId}" class="btn btn-danger">Remove</a>
           </div>
           </td>
